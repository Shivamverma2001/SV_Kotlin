...
//first create an array
    ...
    /* A. ACCESS using get(): now access the element using get() method. It takes
...
//C.now printnusing withIndex()
    for((index,value) in arr.withIndex())
    {
        println("the values $value at index $index")
    }

    // D.access and modify using [] index operator /
    var num=arr[3]
    arr[1]=989
//now print
    for((index,value) in arr.withIndex())
    ...
    /* E.Kotlin program of array traversal using foreach
    loop*/
