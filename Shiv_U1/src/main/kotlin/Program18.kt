...
//A3. rem() – To find the remainder of division
    ...
    var c=sc.nextInt()
    var result1=b.rem(c)
    println("theremainder of $b and $c is $result1")
    println()
...
//A.6 sum()
    ...
    println(arr.sum()) //caaling predefined sum method
    ...
    println()
    println("sum function with return type is :"+ suma(5,6)) //function call

    println("sum1 function as an expression is :"+ suba(10,10)) //function call

}

//B1: function with return type
//function defination where arguments are val type i.e. immutable
fun suma(a:Int, b:Int):Int {
    return a+b
}

//B2:function as an expression : when there is only one liner fxn body that too is return statement
fun suba(a:Int,b:Int):Int=a-b