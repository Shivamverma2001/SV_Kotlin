...
/* Argumentsin function:There are two types of arguments:
...
{2
    ...
    * So to avoic this we have named arguments*/
...
fun defaultArg(a:Int=7,b:String="shelly",c:Float=5.5f) //2^3 different argument mentioning calls are possible to this
{
