...
/*a function which can accepts a function as parameter or can returns
...
fun main(args:Array<String>)
{
    ...
    higherfuncWithfunctionAsArgWithoutReturn("function as an arg in high order fxn which return nothing",::FunctionExp1)
    println()
